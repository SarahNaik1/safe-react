...
const CreateCustomerSafe = React.lazy(() => import('./CreateCustomerSafe'))
...
const Routes = (): React.ReactElement => {
  ...
  return (
    <Switch>
      ...
      <Route component={CreateCustomerSafe} exact path={CREATE_CUSTOMER_SAFE_PAGE}/>
