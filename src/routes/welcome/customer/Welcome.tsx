    ...
    <Page align="center">
      <Block>
        <Title size="md" strong>
          Welcome to HSBC Customer Page.
        </Title>
        <Title size="xs">HSBC Customer Page:</Title>
        <CardsContainer>
          <StyledCard>
            {/* Create Safe */}
            <CardContentContainer>
              ...
              <CardDescriptionContainer>
                <Text size="xl">Create a new Safe that is controlled by you and HSBC.</Text>
                <Text size="xl">You will not be required to pay a network fee for creating your new Safe.</Text>
              </CardDescriptionContainer>
